...
SECRET_KEY = 'a-8nyh)0%xd+r0y=ey5n8tj8_b(0#z=@#9r2an7x^yn2*a51q*'
...
MIDDLEWARE = [
    ...
    #'biling_and_payment.middlewares.AuditMiddleware',
    #'biling_and_payment.middlewares.JournallingMiddleware',
]
